...
/***************************************************************************/
	...
	function themify_custom_css_action($data=array()){
		$data = get_data();
		echo "\n\n<style>".$data['setting-custom_css']."</style>";
	}
	...
	function themify_feed_settings($data=array()){
		$data = get_data();
		return '<p><span class="label">Feed Output</span> <input type="text" class="width6" name="setting-feed_settings" value="'.$data['setting-feed_settings'].'" /></p>
					<p>
						<span class="pushlabel"><small>Use minus sign (-) to exclude categories.</small></span><br />
						...
						while (false !== ($file = readdir($handle))) {
							...
							if($ext == 'jpg' || $ext == 'gif' || $ext == 'png'){
								...
								if(trim($fullpath) == trim($savedpath)){
									$output .= '<a href="#" title="'.$folder.$file.'"><span title="'.$folder.$file.'"></span><img src="'.get_bloginfo('template_directory').'/themify/img.php?w=50&h=50&src='.$fullpath.'" alt="'.$fullpath.'" class="backgroundThumb selected"  /></a>';				
								} else {
									$output .= '<a href="#" title="'.$folder.$file.'"><span title="'.$folder.$file.'"></span><img src="'.get_bloginfo('template_directory').'/themify/img.php?w=50&h=50&src='.$fullpath.'" alt="'.$fullpath.'" class="backgroundThumb" /></a>';
								}
							}
						}		
						closedir($handle);
